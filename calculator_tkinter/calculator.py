...
get_number_button('1').grid(row=2, column=0, stick='wens', padx=5, pady=5)
get_number_button('2').grid(row=2, column=1, stick='wens', padx=5, pady=5)
get_number_button('3').grid(row=2, column=2, stick='wens', padx=5, pady=5)
get_number_button('4').grid(row=3, column=0, stick='wens', padx=5, pady=5)
get_number_button('5').grid(row=3, column=1, stick='wens', padx=5, pady=5)
get_number_button('6').grid(row=3, column=2, stick='wens', padx=5, pady=5)
get_number_button('7').grid(row=4, column=0, stick='wens', padx=5, pady=5)
get_number_button('8').grid(row=4, column=1, stick='wens', padx=5, pady=5)
get_number_button('9').grid(row=4, column=2, stick='wens', padx=5, pady=5)
get_number_button('0').grid(row=5, column=1, stick='wens', padx=5, pady=5)
...
get_operation_button('/').grid(row=5, column=3, stick='wens', padx=5, pady=5)

calculation_button('=').grid(row=5, column=2, stick='wens', padx=5, pady=5)
calculation_button('С').grid(row=5, column=0, stick='wens', padx=5, pady=5)

calculation_button('//').grid(row=1, column=0, stick='wens', padx=5, pady=5)
calculation_button('%').grid(row=1, column=1, stick='wens', padx=5, pady=5)
calculation_button('**').grid(row=1, column=2, stick='wens', padx=5, pady=5)
calculation_button('.%').grid(row=1, column=3, stick='wens', padx=5, pady=5)
